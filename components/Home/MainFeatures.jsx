...
const featureData = [
    {
        title: `Dual Rewards`,
        body: "Scorpion Finance is the next iteration of a reflection token on the Binance Smart Chain (BSC), world's 4th and Europe's first. The unique double reward reflection will be 10% in BNB and 5% in ScorpFin token. Simply hold ScorpFin tokens and get paid, from every buy and sell. The rewards are sent to your wallet.",
        sub:"(10% BNB & 5% Scorpfin)", lottie:reward
    },
    {
        title: "VR and AR Metaverse Gaming",
        body: "World's first VR and AR Metaverse games in crypto. For the very first time, players will get to experience the fusion of crypto, virtual reality and augmented reality in the Metaverse world. Earn tokens, coins and NFTs for completing stages of the game. Think Game, Think Reality"
,sub:" ",lottie:game
    },
    {
